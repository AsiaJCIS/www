...
Official-site addresses are shown as plain text because these host sites may go offline over time; please use the archived copies for a stable reference. Every edition has a local static snapshot kept here ("archived"). For editions whose original site is already offline, the snapshot was reconstructed from the Internet Archive and may be incomplete (missing images or pages). Conference photo galleries are not included in the snapshots.
...
| 2008 | 3rd  | Seoul, Korea | esslab.hanyang.ac.kr/jwis2008 (redirected from cs.sookmyung.ac.kr/~rhee/jwis2008) | [archived](archive/2008-korea/index.html) | — | — |
